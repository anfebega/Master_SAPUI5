 ...
 */
    function (MockServer, JSONModel, UriParameters, Log) {
        ...
        var oMockServer;
        var _sAppPath = "logaligroup/SAPUI5/";
            ...
            init: function (oOptionsParameter) {
                ...
                return new Promise (function(fnResolve, fnReject) {
                    ...
                    oManifestModel.attachRequestCompleted(function() {
                        var oUriParamateres = new UriParameters(window.location.href);
                        ...
                        MockServer.config({
                            autoRespond: true,
                            autoRespondAfter : (oOptions.delay || oUriParamateres.get("serverDelay") || 500 )
                        });
                        ...
                        if (oOptions.metadataError || oUriParamateres.get("metadataError")) {
                        ...
                        var sErrorParam = oOptions.errorType || oUriParamateres.get("errorType");
